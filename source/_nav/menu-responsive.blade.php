<nav id="js-nav-menu" class="w-auto px-2 pt-6 pb-2 bg-gray-200 shadow hidden lg:hidden">
    <ul class="my-0">
        <li class="pl-4">
         ...
         <li class="pl-4">
            <a
                title="{{ $page->GasyCoder }} GasyCoder"
                href="https://gasycoder.com" target="_blank"
                class="block mt-0 mb-4 text-sm no-underline {{ $page->isActive('https://gasycoder.com') ? 'active text-blue-500' : 'text-gray-800 hover:text-blue-500' }}"
            >Company</a>
        </li>
        <li class="pl-4">
            <a
