<nav class="hidden lg:flex items-center justify-end text-lg">
    <a title="{{ $page->siteName }} Blog" href="/blog"
     ...
     <a title="{{ $page->gasycoder }} Gasy Coder" href="https://gasycoder.com" target="_blank"
        class="ml-6 text-gray-700 hover:text-blue-600 {{ $page->isActive('https://gasycoder.com') ? 'active text-blue-600' : '' }}">
        Company
    </a>
